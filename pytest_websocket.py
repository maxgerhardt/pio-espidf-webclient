...
# requires pip install SimpleWebSocketServer
...
class Websocket(object):
    ...
    def run(self):
        if self.use_tls is True:
            ...
            ssl_context.load_cert_chain(certfile='src/certs/server_cert.pem', keyfile='src/certs/server_key.pem')
            if self.client_verify is True:
                ssl_context.load_verify_locations(cafile='src/certs/ca_cert.pem')
